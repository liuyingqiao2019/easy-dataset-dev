...
module.exports = function getQuestionPrompt ({
  ...
  return `
    ...
    ## 核心任务
    根据用户提供的文本（长度：${text.length} 字），生成与${keywords}相关的不少于 ${number} 个高质量问题。
    ...
    - 问题的主语不得为材料本身，不得生成诸如【文件的发布时间是什么？文件发布了多少个文件、印发了什么内容、文件的主要用途是什么】 等无实质意义、无应用价值的低效问题
    ${questionPrompt}
    `;
};
