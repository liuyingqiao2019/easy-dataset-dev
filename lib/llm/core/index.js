...
class LLMClient {
  ...
  constructor (config = {}) {
    this.config = {
      ...
      presencePenalty: DEFAULT_MODEL_SETTINGS.presencePenalty,
      presence_penalty: DEFAULT_MODEL_SETTINGS.presencePenalty,
      frequencyPenalty: DEFAULT_MODEL_SETTINGS.frequencyPenalty,
      frequency_penalty: DEFAULT_MODEL_SETTINGS.frequencyPenalty
    };
    if (config.topP !== 0) {
